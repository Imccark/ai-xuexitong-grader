...
from app.grading_graph.schemas import CandidateResult, OverallLabel, StudentStatus, TeacherDecision
from app.run_batch_grading import parse_result_text
...
def finalize_candidate(
    ...
    *,
    ...
    from app.grading_graph.schemas import FinalResult
