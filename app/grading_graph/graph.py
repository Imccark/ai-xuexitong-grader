...
from app.grading_graph.nodes.aggregator import build_candidate
...
from app.grading_graph.nodes.grader import GradingProvider, QuestionGrader
from app.grading_graph.nodes.math_checks import apply_deterministic_math_checks
...
from app.grading_graph.schemas import Budget, EvidenceRef, PageArtifact, QuestionJob, QuestionResult, QuestionVerdict, RiskLevel, StudentStatus
from app.grading_graph.state import (
...
def build_grading_graph(
    ...
    *,
    ...
    def _budgeted_provider(ledger: BudgetLedger):
        from app.grading_graph.budget import BudgetedJsonProvider
