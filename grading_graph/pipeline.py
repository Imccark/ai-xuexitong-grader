...
from grading_graph.budget import BudgetedJsonProvider, BudgetLedger
...
from grading_graph.nodes.transcriber import LiteralTranscriber
from grading_graph.schemas import AnswerManifest, EvidenceRef, PageArtifact, FileRef, Budget, TranscriptionSpan
from grading_graph.store import file_sha256
    ...
    *,
    ...
    for question_id, answer_slice in manifest.questions.items():
        if question_id not in question_jobs:
            from grading_graph.schemas import QuestionJob
